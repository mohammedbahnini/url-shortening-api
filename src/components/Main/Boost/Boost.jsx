...
function Boost() {
    return (
        <section>
            <div className='bg-very-dark-violet bg-[url("/public/images/bg-boost-mobile.svg")] bg-no-repeat bg-[length:100%] lg:bg-[url("/public/images/bg-boost-desktop.svg")] lg:bg-cover '>
